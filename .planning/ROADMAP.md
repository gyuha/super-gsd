...
- [x] **v2.3 GSD Repository Migration Update** (2026-05-25) — GSD 저장소 이전(`get-shit-done-cc` → `@opengsd/get-shit-done-redux`)에 따른 참조 업데이트 + .agents/skills/ 버그 수정 3건 → [Archive](.planning/milestones/v2.3-ROADMAP.md)
...
- [x] Phase 27: GSD 참조 업데이트 (1/1 plan) — completed 2026-05-24
...
| 27. GSD 참조 업데이트 | v2.3 | 1/1 | Complete | 2026-05-24 |
