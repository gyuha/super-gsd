...
## Current Milestone: v1.3 Codex Platform Support

**Goal:** super-gsd를 OpenAI Codex 환경에서도 사용할 수 있도록 설치 방법 및 적응형 워크플로우 파일을 제공한다.

**Target features:**
- AGENTS.md — Codex에서 super-gsd 워크플로우를 안내하는 AGENTS.md 파일 제공
- .codex/skills/ — Codex API 호환 adapted skill/command 파일 제공
- README Codex 섹션 — 플랫폼별 설치·사용 방법 분리 문서화
