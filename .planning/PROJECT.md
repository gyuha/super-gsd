...
## Current Milestone: v1.5 Visual Companion UI Integration

**Goal:** sg-plan 실행 중 UI 설계가 필요한 단계에서 superpowers visual companion 사용을 제안하고, 독립형 sg-ui-plan 명령으로 언제든 UI를 시각적으로 설계할 수 있게 한다.

**Target features:**
- VC-01: sg-plan UI 단계 감지 — gsd-discuss-phase 이전에 UI 설계 여부 질문
- VC-02: visual companion 수락 시 superpowers:brainstorming 호출 분기
- VC-03: sg-ui-plan 신규 명령 — visual companion 기반 UI 전용 설계
- VC-04: plugin.json + README + COMMANDS.md 등록/문서화
