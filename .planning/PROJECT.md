...
## Current State (v1.5 shipped 2026-05-22)

- **Commands**: 15개 sg- 명령 (sg-ui-plan + sg-parallel-execute 추가)
- **Visual Companion**: sg-plan에 UI 설계 분기(Step 1.5) 내장 — `superpowers:brainstorming` 조건부 실행
- **sg-ui-plan**: UI 설계 전용 독립 명령 — ROADMAP에서 phase 컨텍스트 추출 후 brainstorming 실행, HANDOFF append
...
- **Skills**: `skills/sg-*/SKILL.md` 15개 (v2.0 마이그레이션으로 commands/ → skills/ 전환, commands/ 삭제)
...
---
*Last updated: 2026-05-22 after v1.5 Visual Companion UI Integration milestone*
