...
## Current State (v2.3 shipped 2026-05-25)
...
- **GSD 패키지**: `@opengsd/get-shit-done-redux` — README/CLAUDE/AGENTS/sg-update 전면 반영 (v2.3)
- **.agents/skills/ 버그 수정**: sg-execute idempotency(HANDOFF append 이동), sg-ship 테스트 차단, sg-review SHA 파싱 (v2.3)
...
- **Dependencies**: GSD(`@opengsd/get-shit-done-redux`) + Superpowers 필수. Hookify Optional (sg-retro 내장으로 대체)
- **Version**: 0.0.35
...
- ✓ REF-01: README.md GSD 패키지명 `@opengsd/get-shit-done-redux`로 교체 — v2.3 Phase 27
- ✓ REF-02: README.ko.md 동일 교체 — v2.3 Phase 27
- ✓ REF-03: CLAUDE.md Dependencies 교체 — v2.3 Phase 27
- ✓ REF-04: AGENTS.md Dependencies 교체 — v2.3 Phase 27
- ✓ REF-05: skills/sg-update/SKILL.md 패키지명·설치명령·감지 로직 전면 교체 — v2.3 Phase 27
- ✓ REF-06: .planning/PROJECT.md Constraints 교체 — v2.3 Phase 27
...
---
*Last updated: 2026-05-25 — v2.3 GSD Repository Migration Update 마일스톤 완료. @opengsd/get-shit-done-redux 참조 전면 교체, .agents/skills/ 버그 수정 3건*
