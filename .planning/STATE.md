...
| 260529-d84 | sg-start 또는 sg-explore를 할 때 .planning 폴더를 .gitignore에 추가하도록 수정 (.planning/codebase는 git에 포함) | 2026-05-29 | (pending) | [260529-d84-sg-start-sg-explore-planning-gitignore-p](./quick/260529-d84-sg-start-sg-explore-planning-gitignore-p/) |
