...
## Current Milestone: v2.7 Skills & Hooks Internationalization

**Goal:** `skills/` 및 `hooks/` 내 한글 콘텐츠를 영문으로 전환하고, 모든 SKILL.md에 사용자 언어 자동 감지 지침을 추가한다.

**Target features:**
- `skills/sg-*/SKILL.md` 14개 한글→영문 변환 (I18N-01)
- `.agents/skills/sg-*/SKILL.md` 8개 한글→영문 변환 (I18N-02)
- `hooks/*.cjs` 2개 한글 주석→영문 변환 (I18N-03)
- 27개 모든 SKILL.md에 언어 자동 감지 `<language>` 지침 추가 (I18N-04)
