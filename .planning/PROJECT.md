...
## Current Milestone: v1.3 Multi-Platform Support

**Goal:** Codex, Antigravity CLI(Google), Gemini CLI 사용자도 super-gsd 워크플로우를 사용할 수 있도록 설치 방법 및 적응형 파일을 제공한다.

**Target features:**
- AGENTS.md 재작성 — Codex/Antigravity에서 자동 인식되는 워크플로우 안내
- .agents/skills/ — 3개 플랫폼 공유 스킬 디렉토리 (sg-retro AskUserQuestion 제거 포함)
- .codex/hooks.json + .gemini/settings.json — 플랫폼별 hooks 설정
- README Multi-Platform 섹션 — 기능 delta 테이블 포함
