...
- [x] **Phase 34: $sg-setup 인세션 스킬** — `.agents/skills/sg-setup/SKILL.md` 신규 생성, 세션 내부에서 파일 복사 자동화
- [x] **Phase 35: 문서 개선** — README.md Codex/Gemini 설치 섹션 재작성 + Verify install 섹션 추가 + AGENTS.md 업데이트 + README.ko.md 동기화
